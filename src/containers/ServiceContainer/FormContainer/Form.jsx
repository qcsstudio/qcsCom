...
const Form = ({heading,desc}) => {
  return (
    <div className=' lg:w-[90%]  h-[600px] m-auto relative bg-[#F5F7F9] p-2 mt-8 rounded-xl '>
      <div className=' w-[97%] lg:w-[80%] bg-[#F1813B] absolute rounded-xl h-[580px] z-10 '>
        ...
        <p className={`text-white text-xl sm:text-2xl font-normal px-4 lg:px-0 mt-4 ms-4 lg:ms-8 lg:w-[43%] sm:w-[70%] md:w-[60%] sm:mx-auto ${syne.className}`}>{desc}</p>
      </div>
