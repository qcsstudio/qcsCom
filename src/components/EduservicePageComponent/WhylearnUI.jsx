        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          {data.map(({ id, text }) => (
            ...
            >
              ...
              <h1 className="text-[112px] font-bold bg-gradient-to-b from-[#C6C6C6] to-[#ffffff] bg-clip-text text-transparent leading-none transition-all duration-300 group-hover:text-[#F1813B] group-hover:bg-none group-hover:bg-clip-border">
                {id}
              </h1>
            </div>
          ))}
