...
//         if (!app.file) return app;
        
//         const [fileMeta] = await bucket.find({ _id: app.file }).toArray();
//         return {
//           ...app,
//           fileMeta: fileMeta ? {
...
//             downloadUrl: `/api/applications?download=${fileMeta._id}`
//           } : null
//         };
//       })
//     );
